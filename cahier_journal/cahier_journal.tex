...
%	\bil attention au niveau sonore par rapport aux classes mitoyennes.
	...
	\dIs\car\art{14}{00} Exercice sur le chuchotement et activité libre en art plastique.
	...
	\subsection{\jeu 29 \sep}
	\Dis\csp\eps{8}{45}{Course longue} La moitié de la classe court, l'autre moitié observe et note le nombre de tours effectués par un élève.
	...
	\Dis\cfr\lec{9}{30}{Le cosmonaute} Lecture à voix haute du premier paragraphe par une élève.
	\obj Évaluer la lecture à voix haute.
			
	\Dis\cen\eng{10}{20}{Where are you from} Écoute d’un dialogue de personnes se présentant.
	\obj Savoir reconnaitre qu’il s’agit d’une présentation.
	
	\dIs\cge\gdc{10}{45} Une élève qui n’arrête pas de crier en classe !

	\dIs\cge\gdc{14}{00} Règles de vie de la classe.
	\obj Obtenir un environnement propice aux apprentissages.
	
	
	\subsection{\ven 30 \sep}
	\dis\cfr\voc{8}{45}{Le dictionnaire (2)}{170}
	\cdj{2}{171} Les anagrammes
	\obj correspondance phonographique
	
	%\Dis\cma\nec{9}{30}{À portée de maths -- Les nombres}
	%\cde{Récapitulons 1}{34}
	%\obj Vérifier les acquis avant l’évaluation
	
	\Dis\cen\eng{10}{20}{Where are you from}
	\obj Savoir associer une phrase orale à une phrase graphique.
	
	\dis\cfr\lec{10}{30}{Le cosmonaute} Lecture à voix haute du premier paragraphe par une élève.
	\obj Évaluer la lecture à voix haute.
	...
	\dIs\cge\gdc{14}{00} Retour sur conflit de la cour de récréation.
	
	\Dis\csp\eps{14}{30}{Course longue}
	\obj courir régulièrement
	\bil indiscipline
	
	\Dis\chg\emc{15}{20}{Le respect} Retour sur la moquerie des élèves.
	
	\Dis\chg\emc{15}{45}{Retour sur la semaine}
