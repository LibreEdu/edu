...
\newcommand{\dev}{\textbf{Devoirs : }\mrg{white}{\faHome}}
\newcommand{\nte}{\sdl\textbf{Note : }\mrg{white}{\faPencil}}
\newcommand{\obj}{\sdl\textbf{Objectif : }\mrg{white}{\faBullseye}}
\newcommand{\bil}{\sdl\textbf{Bilan : }\mrg{white}{\faStethoscope}}
\newcommand{\cdj}[2]{\sdl\textbf{Cahier du jour : }\mrg{white}{\faLeanpub} Ex. #1 p. #2.}
\newcommand{\ces}[2]{\sdl\textbf{Cahier d’essai : }\mrg{white}{\faBook} Ex. #1 p. #2.}
\newcommand{\ard}[2]{\sdl\textbf{Ardoise : }\mrg{white}{\faTablet} Ex. #1 p. #2.}
\newcommand{\Ard}{\sdl\textbf{Ardoise : }\mrg{white}{\faTablet}}
